...
public class TetrisFriendsPlayer extends TetrisAIPlayer {
	...
	public TetrisFriendsPlayer() {
		...
		/*
		temp[0] = new Color(63,13,23); //Z
		temp[1] = new Color(14,24,59); //_|
		temp[2] = new Color(64,51,12); //[] 
		temp[3] = new Color(47,11,41); // T
		temp[4] = new Color(28,55,9); //S
		temp[5] = new Color(64,33,10); //L
		temp[6] = new Color(12,45,58); // |
		*/
